...
(BOOK_ID VARCHAR(8),
PROGRAMME _ID VARCHAR2(6),
NO_OF_COPIES INTEGER,
CONSTRAINT PKBC PRIMARY KEY(BOOK_ID, PROGRAMME _ID),
CONSTRAINT FKBC FOREIGN KEY(BOOK_ID) REFERENCES BOOK(BOOK_ID) ON DELETE CASCADE,
CONSTRAINT FKBB FOREIGN KEY(PROGRAMME _ID) REFERENCES LIBRARY_PROGRAMME (PROGRAMME _ID));
...
DATE_OUT DATE,
DUE_DATE DATE,
CONSTRAINT PKBL PRIMARY KEY(BOOK_ID, PROGRAMME _ID,CARD_NO),
